				...
				<div className="grid items-center gap-12 lg:grid-cols-2">
					<div>
						...
						<p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
							Directory Service хранит базовые справочники оргструктуры —
							подразделения, должности и локации — и предоставляет единый
							CRUD-интерфейс для всех внутренних сервисов: HR, Склад, Заказы,
							Скидки и других.
						</p>

						<p className="mt-4 max-w-2xl text-lg leading-8 text-slate-600">
							Благодаря этому данные не дублируются, названия не расходятся
							между системами, а компания получает консистентную и управляемую
				...
				<div className="mt-16">
					<div className="mb-8">
						...
						<p className="mt-3 max-w-3xl text-slate-600">
							Сервис нужен для того, чтобы все внутренние системы работали с
							одной и той же моделью данных, а не создавали свои копии
							справочников.
						</p>
					</div>
					...
					<div className="grid gap-6 md:grid-cols-3">
						{features.map((feature) => (
							...
							>
								<div className="mx-auto mb-4 flex h-12 w-full max-w-40 items-center justify-center rounded-2xl bg-linear-to-br from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-500/20">
				...
				<div className="mt-16 grid gap-6 lg:grid-cols-2">
					<div className="rounded-[1.75rem] border border-slate-200 bg-white p-8 shadow-sm">
						...
						<ul className="mt-5 space-y-4 text-slate-600">
							<li>
								— Видеть структуру компании: кто кому подчиняется и где
								работает.
							</li>
							<li>
								— Быстро находить отделы, должности и офисы в единой системе.
							</li>
							<li>
								— Хранить историю изменений и использовать данные для отчётов.
							</li>
							<li>
								— Исключить расхождения между сервисами и убрать дублирование
								справочников.
							</li>
						</ul>
					</div>
					...
					<div className="rounded-[1.75rem] bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-8 text-white shadow-2xl">
						...
						<p className="mt-5 leading-8 text-slate-300">
							Это не просто справочник, а фундаментальная часть платформы.
							Directory Service становится центром управления организационной
							моделью компании и обеспечивает единообразие данных для всех
							сервисов экосистемы.
						</p>
