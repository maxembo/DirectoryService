...
export function RestoreDepartmentDialog({ departmentId, name }: Props) {
		...
		<Dialog open={open} onOpenChange={handleOpenChange}>
			<DialogTrigger asChild>
				<Button
					...
					aria-label="Восстановить подразделение"
				>
			...
			<DialogContent>
				<DialogHeader>
					<DialogTitle>Восстановить подразделение</DialogTitle>
				</DialogHeader>
				<div className="min-w-0">
					<p>Вы уверены, что хотите восстановить подразделение?</p>

					<p className="mt-2 max-h-32  max-w-full overflow-y-auto  wrap-break-word text-xl font-medium text-blue-500">
						«{name}»
					</p>
				</div>
